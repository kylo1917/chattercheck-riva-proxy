...
const FUNCTION_ID = 'd3fe9151-442b-4204-a70d-5fcc597fd610'; // nvidia/parakeet-tdt-0.6b-v2 — must match api/diarize.js
...
// Mirrors the exact request shape api/diarize.js sends for a real session —
// same model, same diarization config, same punctuation flag — so a pass
// here means the real recording path will actually work, not just that the
// key is valid in the abstract.
